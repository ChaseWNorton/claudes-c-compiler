...
impl Driver {
    pub fn new() -> Self {
        Self {
            ...
            input_files: Vec::new(),
            opt_level: 0, // Default matches GCC: no optimization without -O flag
    ...
    fn compile_to_assembly(&self, input_file: &str) -> Result<String, String> {
        ...
        let opts = crate::backend::CodegenOptions {
            ...
            function_sections: self.function_sections || self.optimize_size,
            data_sections: self.data_sections || self.optimize_size,
